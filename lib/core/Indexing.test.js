...
*/
    test('unique', async () => {
        ...
        expect(await indx.isUnique(fieldName, 'fish')).toEqual(true);
        expect(await indx.isUnique(fieldName, 'tiger')).toEqual(false);
    ...
    test.only('numeric', async () => {
        ...
        vals.sort();
        let scores = _.map(setList, 'score');
